...
TOOLS = [
    ...
    ('move-dex',    '#5f7f1a', '#c3e85a', 'わざ図鑑'),
    ('bulk',        '#4b6f8c', '#8ec9ff', '耐久指数ランキング'),
    ('max-type',    '#b04262', '#ff7a9c', 'マックスバトルタイプ別アタッカーランキング'),
    ('max-type-tank', '#1f7a70', '#4ad6b8', 'マックスバトルタイプ別タンクランキング'),
]
