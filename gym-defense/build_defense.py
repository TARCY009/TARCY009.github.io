...
#     …攻撃できても1発で溶けるポケモンは撃つ前に倒される、という理屈（2026-08-19・タダシさん指示で
...
#   ラウドボーン: ブラストバーン(120×1.2=144点)は発生2.95秒＞基準2.6秒の罰則で86.9点まで落ち、
#   フレアソング(発生2.5秒・罰則なし・120点)の72.4%＝併記ライン80%に届かない（2026-08-20タダシさん指示）
MANUAL_RECOMMEND = {
    'トゲキッス': ('マジカルシャイン', 'はどうだん'),
    'ラウドボーン': ('シャドーボール', 'ブラストバーン'),
}
