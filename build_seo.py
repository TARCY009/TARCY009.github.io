...
PAGES = [
  dict(path='/', key='home',
       ...
       desc='GOナビはポケモンGOの攻略ツール集です。レイドの火力ランキング、トレーナーバトルの対面シミュレート、個体値の順位、ジムの攻め・守り、マックスバトル対策まで15個の道具を無料で使えます。',
       og_title='GOナビ｜ポケモンGO 攻略ツール',
       og_desc='レイドの火力、GBLの対面、個体値の順位まで。15個の道具を無料で使えます。',
       eyebrow='POKÉMON GO TOOLS', name='GOナビ',
       tag='レイド・ジム・トレーナーバトル・個体値。15個の攻略ツールを無料で。',
