...
PAGES = [
  ...
  dict(path='/guide/gbl-simulator-tips/', key='home', title='GBLシミュレーターの使い方と上達のコツ｜対面・パーティ・模擬戦の使い分け｜GOナビ',
       desc='ポケモンGOのGOバトルリーグ向けGBLシミュレーターの5つのモード（1対1・環境一覧・対策さがし・パーティ診断・模擬戦）の使い分けと、有利な対面を取り続ける・SPアタックの撃ち方・ブラフの考え方など上達のコツを解説します。',
       og_title='GBLシミュレーターの使い方と上達のコツ｜GOナビ', og_desc='5つのモードの使い分けと、バトルで役立つ考え方をまとめました。', ld='article'),
