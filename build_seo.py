...
PAGES = [
  dict(path='/', key='home',
       ...
       desc='GOナビはポケモンGOの攻略ツール集です。レイドの火力ランキング、トレーナーバトルの対面シミュレート、個体値の順位、ジムの攻め・守り、マックスバトル対策まで16個の道具を無料で使えます。',
       og_title='GOナビ｜ポケモンGO 攻略ツール',
       og_desc='レイドの火力、GBLの対面、個体値の順位まで。16個の道具を無料で使えます。',
       eyebrow='POKÉMON GO TOOLS', name='GOナビ',
       tag='レイド・ジム・トレーナーバトル・個体値。16個の攻略ツールを無料で。',
  ...
  dict(path='/max-type/', key='max-type',
       title='マックスバトル タイプ別アタッカーランキング｜ポケモンGOのダイマックス最強アタッカー｜GOナビ',
       desc='ポケモンGOのマックスバトルで、ほのお・みず・ドラゴンなどタイプごとに最強のアタッカーを、ダイマックスフェイズの火力順に並べたランキング。ダイマックス・キョダイマックスのわざと0.5秒技も確認できます。',
       og_title='マックスバトル タイプ別アタッカーランキング｜ポケモンGO',
       og_desc='タイプごとに、ダイマックスフェイズで強いアタッカーが分かります。',
       eyebrow='POKÉMON GO MAX ATTACKER', name='マックスバトル タイプ別アタッカーランキング',
       tag='タイプごとの最強アタッカー',
       color='#ff7a9c', ld='app'),
  dict(path='/max-type/tank/', key='max-type-tank',
       title='マックスバトル タイプ別タンクランキング｜ポケモンGOのダイマックスおすすめタンク｜GOナビ',
       desc='ポケモンGOのマックスバトルで、ボスのわざのタイプごとに倒されにくいタンクを耐久順に並べたランキング。ダイウォールの壁込みで、防御が高いポケモンを評価する並びにも切り替えられます。',
       og_title='マックスバトル タイプ別タンクランキング｜ポケモンGO',
       og_desc='受けるわざのタイプごとに、倒されにくいタンクが分かります。',
       eyebrow='POKÉMON GO MAX TANK', name='マックスバトル タイプ別タンクランキング',
       tag='受けるタイプごとの最強タンク',
       color='#4ad6b8', ld='app'),
  ...
  dict(path='/pokedex/', key='pokedex',
       ...
       color='#bd93ff', ld='app'),
  dict(path='/move-dex/', key='move-dex',
       title='わざ図鑑｜ポケモンGOのわざ性能一覧（タイプ別）｜GOナビ',
       desc='ポケモンGOの全わざをタイプごとに一覧にしたわざ図鑑。ノーマルアタック・SPアタック・メガシンカの＋わざについて、ジム・レイドとトレーナーバトルの威力・ゲージ・DPS/DPT/DPE・能力変化と、覚えるポケモンを確認できます。',
       og_title='わざ図鑑｜ポケモンGO',
       og_desc='タイプを選ぶだけで、わざの性能と覚えるポケモンが分かります。',
       eyebrow='POKÉMON GO MOVE DEX', name='わざ図鑑',
       tag='タイプを選ぶだけで、わざの性能と覚えるポケモンが分かります',
       color='#c3e85a', ld='app'),
  ...
  dict(path='/guide/raid-dps/', key='home', title='レイドの「火力（DPS）」の読み方｜ランキングの数字はどう決まるか｜GOナビ',
       desc='ポケモンGOのレイドの火力（DPS）は、ノーマルアタックとSPアタックを組み合わせた1秒あたりのダメージ。ものさしにした相手、ダメージの式と倍率、わざ構成の選ばれ方、数字に入っていないものまで解説します。',
       og_title='レイドの「火力（DPS）」の読み方｜GOナビ', og_desc='レイド火力ランキングの数字が何を前提にどう計算されているかを解説。', ld='article'),
  dict(path='/guide/raid-players/', key='home', title='レイドの「最少討伐人数」｜理論値と実戦の目安が違う理由｜GOナビ',
       desc='ポケモンGOのレイドを何人で倒せるか。理論値の求め方、ランクごとのHPと制限時間、ボスの攻撃のタイミング、ゲージのやりとり、スーパーメガレイドのシールドまで、理論値と実戦の目安が違う理由を解説します。',
       og_title='レイドの「最少討伐人数」｜GOナビ', og_desc='理論値と実戦の目安で人数が違う理由を、ボスの攻撃とゲージのしくみから解説。', ld='article'),
  dict(path='/guide/super-mega-shield/', key='home', title='スーパーメガレイドのシールドの仕組み｜枚数・割り方・倍率｜GOナビ',
       desc='ポケモンGOのスーパーメガレイドでボスが張るシールドについて、張られるタイミング、ボスごとの枚数（7〜10枚）、メガシンカのSPアタックでの割り方、ミュウツー効果の1人2枚、シールド中の攻撃1.8倍・防御の倍率まで解説します。',
       og_title='スーパーメガレイドのシールドの仕組み｜GOナビ', og_desc='シールドの枚数・割り方・シールド中のボスの倍率を解説。', ld='article'),
  dict(path='/guide/mega-plus-moves/', key='home', title='メガシンカの「＋わざ」とメガレベル｜威力の倍率と使える場面｜GOナビ',
       desc='ポケモンGOのメガシンカ中だけ使える3本目のSPアタック「＋わざ」について、覚える条件（メガLv4に届く16匹）、レイドとGOバトルリーグで使えてジムでは使えないこと、メガレベルごとの威力の倍率、16匹のわざの性能をまとめて解説します。',
       og_title='メガシンカの「＋わざ」とメガレベル｜GOナビ', og_desc='3本目のSPアタック「＋わざ」の条件・倍率・16匹の性能をまとめて解説。', ld='article'),
  dict(path='/guide/breakpoint/', key='home', title='ブレイクポイントとは｜ノーマルアタックの1ダメージが試合を変える理由｜GOナビ',
       desc='ポケモンGOのトレーナーバトルで、ノーマルアタックのダメージが1増える境目（ブレイクポイント）とは何か。ダメージが階段状に増えるしくみ、1ターンのわざほど影響が大きい理由、マスターリーグとCP上限のあるリーグでの考え方を解説します。',
       og_title='ブレイクポイントとは｜GOナビ', og_desc='ノーマルアタックの1ダメージが試合を変える理由を、ダメージの式から解説。', ld='article'),
  dict(path='/guide/gbl-turns/', key='home', title='GBLの「ターン」の仕組み｜0.5秒刻みで何が起きているか｜GOナビ',
       desc='ポケモンGOのGOバトルリーグは0.5秒ごとのターンで進みます。ノーマルアタックが当たるターン、SPアタックが始まるターン、同じターンに重なったときの順番、SPアタックの同時発動、制限時間4分30秒の勝敗まで、2026年6月からの新しいバトルシステムにもとづいて解説します。',
       og_title='GBLの「ターン」の仕組み｜GOナビ', og_desc='0.5秒刻みのターンで何が起きているかを、同じターンの順番まで解説。', ld='article'),
  dict(path='/guide/gbl-optimal-throw/', key='home', title='最適撃ち早見表｜ノーマルアタック何発目でSPアタックを撃つか｜GOナビ',
       desc='ポケモンGOのGOバトルリーグで、SPアタックを相手のノーマルアタックの切れ目に合わせて撃つ「最適撃ち」を、自分と相手のノーマルアタックのターン数ごとの早見表にまとめました。表の読み方と、最適撃ちにこだわらない場面も解説します。',
       og_title='最適撃ち早見表｜GOナビ', og_desc='ノーマルアタック何発目でSPアタックを撃つかを、ターン数ごとの1枚の表で。', ld='article'),
  dict(path='/guide/gbl-shield-bluff/', key='home', title='GBLのシールドと「ブラフ」｜2枚のシールドで何が防げて何が防げないか｜GOナビ',
       desc='ポケモンGOのGOバトルリーグで1バトルに2枚使えるシールドについて、防げるもの・防げないもの（能力変化は防げない）、軽いSPアタックでシールドを使わせる「ブラフ」、シールドの枚数ごとに結果が変わる理由を解説します。',
       og_title='GBLのシールドと「ブラフ」｜GOナビ', og_desc='2枚のシールドで何が防げて何が防げないか、ブラフのしくみまで解説。', ld='article'),
  dict(path='/guide/gbl-swap/', key='home', title='GBLの交代のルール｜45秒・交代にかかる1ターン・能力変化のリセット｜GOナビ',
       desc='ポケモンGOのGOバトルリーグの交代のルールをまとめて解説。交代のクールタイム45秒、交代にかかる1ターンとSPアタック直後の例外、交代先に入る打ちかけの1発、能力変化のリセットと例外、倒れたあとの出し直し、交代受けまで。',
       og_title='GBLの交代のルール｜GOナビ', og_desc='45秒のクールタイムから能力変化のリセットまで、交代のルールを解説。', ld='article'),
  dict(path='/guide/gbl-charge/', key='home', title='SPアタックの威力調整｜NICE・GREAT・EXCELLENTで何が変わるか｜GOナビ',
       desc='ポケモンGOのトレーナーバトルで、SPアタックの操作の出来（NICE・GREAT・EXCELLENT）によって威力が25〜100%に変わるしくみ。入力の時間7秒、ノーマルアタックやゲージの消費は変わらないこと、シールドとの関係、シミュレーターでの扱いを解説します。',
       og_title='SPアタックの威力調整｜GOナビ', og_desc='NICE・GREAT・EXCELLENTでSPアタックの威力がどれだけ変わるかを解説。', ld='article'),
  dict(path='/guide/gym-defense/', key='home', title='ジムに置くと長く残るポケモンの条件｜耐久・かくとう相性・やる気｜GOナビ',
       desc='ポケモンGOのジムに置いたとき長く残りやすいポケモンを比べる基準を解説。耐久指数（HP×防御）、かくとうタイプとの相性、やる気の下がりにくさ、防衛側の攻撃に入る約2秒の待ち時間まで。',
       og_title='ジムに置くと長く残るポケモンの条件｜GOナビ', og_desc='耐久・かくとうとの相性・やる気から、ジムで長く残るポケモンの条件を解説。', ld='article'),
  dict(path='/guide/max-battle-roles/', key='home', title='マックスバトルのアタッカーとタンクの選び方｜マックスわざとメーターの仕組み｜GOナビ',
       desc='ポケモンGOのマックスバトルで、アタッカーとタンクを何で比べればよいかを解説。威力が固定のマックスわざのダメージ、ノーマルアタックで決まるわざのタイプ、マックスメーターのたまり方（★5・★6の倍率）、ダイウォールの壁まで。',
       og_title='マックスバトルのアタッカーとタンクの選び方｜GOナビ', og_desc='マックスわざの威力とメーターのしくみから、アタッカーとタンクの選び方を解説。', ld='article'),
  dict(path='/guide/philosophy/', key='home', title='GOナビを作るときに大切にしていること｜運営者の考え方｜GOナビ',
       desc='ポケモンGO攻略ツール集「GOナビ」を作るときに大切にしている考え方。ぱっと見でわかる画面、実測で確かめる計算の正確さ、取りこぼしを出さないこと、正解の型を押しつけないこと、練習になることなど。',
       og_title='GOナビを作るときに大切にしていること｜GOナビ', og_desc='ツールを作るうえで決めている考え方をまとめました。', ld='article'),
  dict(path='/guide/battle-types/', key='home', title='ポケモンGOのバトルの種類と仕組み｜レイド・マックスバトル・ジム・GBL・ロケット団｜GOナビ',
       desc='ポケモンGOのレイドバトル・マックスバトル・ジムバトル・GOバトルリーグ・GOロケット団とのバトルについて、それぞれの仕組みと面白さを1つにまとめて解説します。',
       og_title='ポケモンGOのバトルの種類と仕組み｜GOナビ', og_desc='5種類のバトルの仕組みと面白さをまとめて解説。', ld='article'),
  dict(path='/guide/type-chart/', key='home', title='ポケモンGOのタイプ相性の倍率｜1.6倍・0.625倍・二重弱点の計算｜GOナビ',
       desc='ポケモンGOのタイプ相性の倍率（こうかばつぐん1.6倍・いまひとつ0.625倍・0.390625倍）と、2つのタイプを持つポケモンへの掛け算、タイプ一致1.2倍との関係を解説します。',
       og_title='ポケモンGOのタイプ相性の倍率｜GOナビ', og_desc='本家と違うタイプ相性の倍率と、二重弱点・二重耐性の計算を解説。', ld='article'),
  dict(path='/guide/shadow-pokemon/', key='home', title='シャドウポケモンの仕組み｜攻撃1.2倍と防御の低下・個体値の下限｜GOナビ',
       desc='ポケモンGOのシャドウポケモンは与えるダメージも受けるダメージも1.2倍。レイドとGOバトルリーグでの向き不向き、同時発動との関係、シャドウレイドの個体値の下限6までを解説します。',
       og_title='シャドウポケモンの仕組み｜GOナビ', og_desc='攻撃1.2倍と打たれ弱さ、バトルごとの向き不向きを解説。', ld='article'),
  dict(path='/guide/raid-bonuses/', key='home', title='レイドのボーナスまとめ｜天候・フレンド・メガシンカの応援・フィールド効果・チームパワー｜GOナビ',
       desc='ポケモンGOのレイドでダメージを上げるボーナスの倍率をまとめて解説。天候ブーストの対応タイプ、フレンドボーナス、メガシンカの応援、フィールド効果（ザシアン・ミュウツー）、チームパワー、ボーナスでボスの攻撃が増える仕組みまで。',
       og_title='レイドのボーナスまとめ｜GOナビ', og_desc='天候・フレンド・メガ応援・フィールド効果・チームパワーの倍率を解説。', ld='article'),
  dict(path='/guide/bulk-index/', key='home', title='耐久指数とは｜倒されにくさを1つの数字で比べる｜GOナビ',
       desc='ポケモンGOの倒されにくさを比べる耐久指数（HP種族値×防御種族値）について、求め方、シャドウポケモンの扱い、極低耐久の目安、ジム・マックスバトル・レイドでの使い道を解説します。',
       og_title='耐久指数とは｜GOナビ', og_desc='HPと防御の掛け算で倒されにくさを比べる耐久指数を解説。', ld='article'),
  dict(path='/guide/gbl-simulator-tips/', key='home', title='GBLシミュレーターの使い方｜対面・パーティ・模擬戦の使い分け｜GOナビ',
       desc='ポケモンGOのGOバトルリーグ向けGBLシミュレーターの5つのモード（1対1・環境一覧・対策さがし・パーティ診断・模擬戦）で何が分かるか、使う順番の例、1対1の結果の見方、模擬戦で練習できることを解説します。',
       og_title='GBLシミュレーターの使い方｜GOナビ', og_desc='5つのモードの使い分けと、1対1の結果の見方・模擬戦で練習できることをまとめました。', ld='article'),
  dict(path='/guide/gbl-party-types/', key='home', title='GBLのパーティの型｜ABC・ABB・ABAと「得意な場面」｜GOナビ',
       desc='ポケモンGOのGOバトルリーグで3匹を役割で見るABC・ABB・ABAの考え方と回し方の例、シールドが残る序盤とシールドが切れた終盤で強いポケモンの違いを解説します。',
       og_title='GBLのパーティの型｜GOナビ', og_desc='ABC・ABB・ABAの考え方と、序盤・終盤に強いポケモンの見方。', ld='article'),
  dict(path='/guide/showdown/', key='home', title='見せ合い（6匹から3匹を選ぶ）の考え方｜選出と並び順｜GOナビ',
       desc='ポケモンGOの大会などで使われる、6匹を見せ合ってから3匹を選ぶルールについて、パーティのルール、選出の考え方、GOナビの模擬戦での練習のしかたを解説します。',
       og_title='見せ合い（6匹から3匹）の考え方｜GOナビ', og_desc='6匹から3匹を選ぶルールの選出の考え方を解説。', ld='article'),
  dict(path='/guide/iv-checker-howto/', key='home', title='個体値チェッカーの使い方｜入力例で見る順位・PL・進化後のCP｜GOナビ',
       desc='ポケモンGOの個体値チェッカーの使い方を入力例で解説。4リーグの順位の読み方、いまのCPからPLを割り出して進化後のCPを調べる方法、順位の前提、CPから個体値を逆に調べる方法まで。',
       og_title='個体値チェッカーの使い方｜GOナビ', og_desc='入力例で、順位・PL・進化後のCPの調べ方を解説。', ld='article'),
  dict(path='/guide/rocket-basics/', key='home', title='GOロケット団バトルの仕組み｜硬直・SPアタックの待ち時間・早く倒すコツ｜GOナビ',
       desc='ポケモンGOのGOロケット団とのバトルの仕組みを解説。相手が動けない硬直の秒数、SPアタックの待ち時間、したっぱ・リーダー・サカキの違い、相手のわざがランダムなこと、早く倒すための考え方まで。',
       og_title='GOロケット団バトルの仕組み｜GOナビ', og_desc='硬直とSPアタックの待ち時間から、早く倒す考え方を解説。', ld='article'),
...
NAME_BR = {
  ...
  'bulk': '耐久指数|ランキング', 'max-type': 'マックスバトル|タイプ別アタッカー|ランキング', 'max-type-tank': 'マックスバトル|タイプ別タンク|ランキング', 'iv-checker': '個体値|チェッカー',
}
for _p in PAGES:
